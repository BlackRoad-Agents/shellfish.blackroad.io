...
**shellfish.ulackroad.io** is part of the **BlackRoad OS** ecosystem — a sovereign, distributed operating system built on edge computing, local AI, and mesh networking by **BlackRoad OS, Inc.**
...
## Getting Started
```bash
git clone https://github.com/BlackRoad-Agents/shellfish.blackroad.io.git
cd shellfish.blackroad.io
```
